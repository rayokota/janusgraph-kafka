...
cp conf/janusgraph-kafka.properties ${JANUS_CONF_PATH}
cp conf/kcache.properties ${JANUS_CONF_PATH}
cp conf/janusgraph-kafka-es-server.properties ${JANUS_GREMLIN_SERVER_CONF}
cp conf/kcache.properties ${JANUS_GREMLIN_SERVER_CONF}
